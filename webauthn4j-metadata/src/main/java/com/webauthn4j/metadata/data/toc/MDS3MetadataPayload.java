 ...
 */
public class MDS3MetadataPayload implements Serializable {
    ...
    @JsonProperty
    private final List<MDS3MetadataPayloadEntry> entries;

    @JsonCreator
    public MDS3MetadataPayload(
            @JsonProperty("legalHeader") String legalHeader,
            @JsonProperty("no") Integer no,
            @JsonProperty("nextUpdate") LocalDate nextUpdate,
            @JsonProperty("entries") List<MDS3MetadataPayloadEntry> entries) {
    ...
    public List<MDS3MetadataPayloadEntry> getEntries() {
        return entries;
    }
    ...
    public boolean equals(Object o) {
        ...
        MDS3MetadataPayload that = (MDS3MetadataPayload) o;
